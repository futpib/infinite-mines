...
- The active session is saved to IndexedDB with the single current snapshot schema and 9-byte sparse cell records; writes are debounced after actions and never run on drag frames.
