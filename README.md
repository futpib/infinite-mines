...
- A compact cell locator exposes the hovered coordinates and visible state; clicking it copies the seed, density, Things choice, safe origin, scale, and theme needed to reproduce that cell without exposing concealed mines.
